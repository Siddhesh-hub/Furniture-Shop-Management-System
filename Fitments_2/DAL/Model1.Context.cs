...
namespace Fitments_2.DAL
{
    ...
    public partial class Fitments_2Entities2 : DbContext
    {
        public Fitments_2Entities2()
            : base("name=Fitments_2Entities2")
        {
        }
        ...
        public virtual DbSet<Tbl_SiteUser> Tbl_SiteUser { get; set; }
